...
{
    public class GridIFrameAlertModel : BaseModel
    {
        public void OnGet()
        {
        ...
        public IActionResult OnPostWindow1_Close(string Grid1_sourceKey, string[] Grid1_fields, string Window1_closeArgument)
        {
            // 重新绑定表格数据（模拟）
