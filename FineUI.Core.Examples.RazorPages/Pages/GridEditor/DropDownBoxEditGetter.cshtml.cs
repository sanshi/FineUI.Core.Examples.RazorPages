...
{
    public class DropDownBoxEditGetterModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.DropDownBoxEditGetter";
        ...
        private DataTable GetSourceData()
        {
            ...
            {
                HttpContext.Session.SetObject(KEY_FOR_DATASOURCE_SESSION, DataSourceUtil.GetEmptyDataTable());
            }
