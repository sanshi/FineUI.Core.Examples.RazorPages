...
{
    public class UpdateSummaryModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            ViewBag.Grid1DataSource = source;
        }
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.UpdateSummary";
