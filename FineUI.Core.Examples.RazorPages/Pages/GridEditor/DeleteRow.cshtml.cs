...
{
    public class DeleteRowModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostGrid1_DeleteRows(string[] Grid1_fields, string[] selectedRows)
        {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.DeleteRow";
