...
{
    public class GridEditorProgressModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private void UpdateDataRow(JObject modifiedRow, int rowId, DataTable source)
        {
            ...
            UpdateDataRow("Progress1", rowDict, rowData);
            UpdateDataRow("Progress2", rowDict, rowData);
        }

        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.GridEditorProgress";
