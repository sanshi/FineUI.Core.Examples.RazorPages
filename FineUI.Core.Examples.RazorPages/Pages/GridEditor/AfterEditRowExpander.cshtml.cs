...
{
    public class AfterEditRowExpanderModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostGrid1_AfterEdit(string[] Grid1_fields, JArray Grid1_modifiedData)
        {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.AfterEditRowExpander";
