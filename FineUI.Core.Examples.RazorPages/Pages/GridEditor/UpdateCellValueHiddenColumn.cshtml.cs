...
{
    public class UpdateCellValueHiddenColumnModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.UpdateCellValueHiddenColumn";
