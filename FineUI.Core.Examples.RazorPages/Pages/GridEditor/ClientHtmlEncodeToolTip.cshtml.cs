...
{
    public class ClientHtmlEncodeToolTipModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridEditor.ClientHtmlEncodeTooltip";
        ...
        private DataTable GetSourceData()
        {
            if (HttpContext.Session.GetObject<DataTable>(KEY_FOR_DATASOURCE_SESSION) == null)
            {
                ...
                HttpContext.Session.SetObject(KEY_FOR_DATASOURCE_SESSION, table);
            }
