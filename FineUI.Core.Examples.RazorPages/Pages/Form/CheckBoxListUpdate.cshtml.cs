...
{
    public class CheckBoxListUpdateModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostBtnCheckedItemsList_Click(string name, string[] selected)
        {
            ShowNotify(String.Format(name + "的选中项：{0}", String.Join(", ", selected)));

            return UIHelper.Result();
        }

        public IActionResult OnPostBtnUpdateList1_Click()
        {
        ...
        public IActionResult OnPostBtnUpdateList2_Click()
        {
        ...
        public IActionResult OnPostBtnUpdateList4_Click(int count)
        {
        ...
        public IActionResult OnPostBtnUpdateList3_Click()
        {
