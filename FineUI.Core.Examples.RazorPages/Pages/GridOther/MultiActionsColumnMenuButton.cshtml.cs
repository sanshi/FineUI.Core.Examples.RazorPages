...
{
    public class MultiActionsColumnMenuButtonModel : BaseModel
    {
        public void OnGet()
        {
        ...
        public IActionResult OnPostGrid1_CustomEdit(string actionName, int rowIndex, string rowId, string rowText)
        {
