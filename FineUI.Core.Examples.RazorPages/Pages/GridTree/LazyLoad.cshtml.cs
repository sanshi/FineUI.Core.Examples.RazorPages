...
{
    public class LazyLoadModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostGrid1_RowLazyLoad(string rowId, string[] Grid1_fields)
        {
            ...
            {
                // basic文件夹
                grid1.LoadData(rowId, GetBasicFolderDataTable(), Grid1_fields);
            }
            else if (rowId == "54")
            {
                // Captcha文件夹
                grid1.LoadData(rowId, GetCaptchaFolderDataTable(), Grid1_fields);
            }
