...
{
    public class RowMoveMultiModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostGrid1_RowMove(JArray rowIds)
        {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridMove.RowMoveMulti";
