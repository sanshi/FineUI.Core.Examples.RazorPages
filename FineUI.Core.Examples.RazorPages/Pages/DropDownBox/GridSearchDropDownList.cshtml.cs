...
{
    public class GridSearchDropDownListModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostGrid1_DoReBind(string[] Grid1_fields, int Grid1_pageIndex, string ddlAtSchool, JArray Grid1_filteredData)
        {
