...
{
    public class GridSearchModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostTtbSearch_Trigger1Click(string[] Grid1_fields, int Grid1_pageIndex)
        {
        ...
        public IActionResult OnPostGrid1_DoReBind(string[] Grid1_fields, int Grid1_pageIndex, string ttbSearch)
        {
        ...
        private void ReBindGrid(string[] Grid1_fields, int Grid1_pageIndex, string ttbSearch)
        {
            ...
            // 2.获取当前分页数据
            var dataSource = DataSourceUtil.GetPagedDataTable(pageIndex: Grid1_pageIndex, pageSize: 5,  searchKeyword: ttbSearch);
