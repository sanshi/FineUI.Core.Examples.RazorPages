...
{
    public class GridLayoutAlwaysDisplayDefaultValueModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            // 2.获取当前分页数据
            ViewBag.Grid1DataSource = GetPagedDataTable(pageIndex: 0, pageSize: 5);

        }

        #endregion

        public IActionResult OnPostTtbSearch_Trigger1Click(string[] Grid1_fields, int Grid1_pageIndex, string rblAtSchool)
        {
        ...
        public IActionResult OnPostGrid1_DoReBind(string[] Grid1_fields, int Grid1_pageIndex, string ttbSearch, string rblAtSchool)
        {
        ...
        {
            return GetPagedDataTable(pageIndex, pageSize, String.Empty, "-1");
        }
        ...
        /// </summary>
        /// <returns></returns>
        private DataTable GetPagedDataTable(int pageIndex, int pageSize, string ttbSearch, string rblAtSchool)
        {
        ...
        private DataTable GetSource(string ttbSearch, string rblAtSchool)
        {
            ...
            if (!String.IsNullOrEmpty(rblAtSchool) && rblAtSchool != "-1")
            {
