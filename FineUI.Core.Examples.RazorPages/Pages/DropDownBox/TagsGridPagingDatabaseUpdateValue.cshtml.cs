...
{
    public class TagsGridPagingDatabaseUpdateValueModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        {
            UIHelper.DropDownBox("DropDownBox1").Values("109,110", "张娟娟,叶鹏");

            return UIHelper.Result();
        }


        public IActionResult OnPostBtnClearValue_Click()
        {
            UIHelper.DropDownBox("DropDownBox1").Values("");
