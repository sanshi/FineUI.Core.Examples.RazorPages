...
{
    public class GroupFieldHiddenModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostButton3_Click(bool anhuiHidden)
        {
            var grid1 = UIHelper.Grid("Grid1");
            if (anhuiHidden)
            {
                grid1.ShowColumn("anhui");
            }
            else
            {
                grid1.HideColumn("anhui");
            }
        ...
        public IActionResult OnPostButton1_Click(bool zhumadianHidden)
        {
            var grid1 = UIHelper.Grid("Grid1");
            if (zhumadianHidden)
            {
                grid1.ShowColumn("zhumadian");
            }
            else
            {
                grid1.HideColumn("zhumadian");
            }
