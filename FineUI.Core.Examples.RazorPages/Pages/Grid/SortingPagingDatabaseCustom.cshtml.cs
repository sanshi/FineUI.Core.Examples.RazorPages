...
{
    public class SortingPagingDatabaseCustomModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        public IActionResult OnPostGrid1_PageIndexChangedOrSort(string[] fields, int pageIndex, string sortField, string sortDirection)
        {
            ...
            // 2.获取当前分页数据
            var dataSource = DataSourceUtil.GetPagedDataTable(pageIndex: pageIndex, pageSize: 5,  sortField: sortField, sortDirection: sortDirection);
