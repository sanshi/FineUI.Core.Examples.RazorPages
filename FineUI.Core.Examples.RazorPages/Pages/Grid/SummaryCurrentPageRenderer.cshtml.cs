...
{
    public class SummaryCurrentPageRendererModel : BaseModel
    {
        public void OnGet()
        {
            LoadData();
        ...
        private void LoadData()
        {
            ...
            // 2.获取当前分页数据
            var pagedDataTable = DataSourceUtil.GetPagedDataTable(pageIndex: 0, pageSize: 5);
            ViewBag.Grid1DataSource = pagedDataTable;

            // 3. 合计行数据
            ViewBag.Grid1SummaryData = GetSummaryData(pagedDataTable);
        }
