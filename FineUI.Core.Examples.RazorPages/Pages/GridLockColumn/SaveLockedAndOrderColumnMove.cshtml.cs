...
{
    public class SaveLockedAndOrderColumnMoveModel : BaseModel
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridLockColumn.SaveLockedAndOrderColumnMove";
