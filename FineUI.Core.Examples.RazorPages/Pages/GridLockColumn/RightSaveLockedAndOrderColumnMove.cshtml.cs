...
{
    public class RightSaveLockedAndOrderColumnMoveModel : BaseModel
    {
        ...
        private static readonly string KEY_FOR_DATASOURCE_SESSION = "GridLockColumn.RightSaveLockedAndOrderColumnMove";
